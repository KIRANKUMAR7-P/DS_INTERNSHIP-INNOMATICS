...
with open(r'C:\Users\pamar\Downloads\New folder\langchai_rag\google_api.txt', 'r') as f:
...
def main():
    ...
    st.markdown("<h2 style='color:blue;'>Ask a Question</h2>", unsafe_allow_html=True)
    ...
    pdf_path = r"C:\Users\pamar\Downloads\New folder\langchai_rag\2404.07143.pdf"  # Replace with your PDF path
